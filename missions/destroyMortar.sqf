...
|_____
|
|   Description: Destroy Mortar Emplacement.
|
...
_mortar = "B_rr_mortar_F" createVehicle rndPos;
_mortar setDamage .9;
_mortar setAmmo 0;
...
_marker = createMarker ["destroyMortar_mrk", getMarkerPos _missionLoc ];
...
_marker2 = createMarker ["destroyMortar_1_mrk", getMarkerPos _missionLoc];
...
_misHintText = format
	[
		"<t align='center' size='2.2'>New Op</t><br/><t size='1.5' align='center' color='#FFCF11'>%1</t><br/>____________________<br/>OPFOR has set up a Mortar emplacement. Destroy it ASAP to allow our forces to push up. <br/><br/>",
		_missionName
	];

["Globalhint_EH", [_misHintText]] call ace_common_fnc_globalEvent;

waituntil{!alive _mortar};
