...
// REDFOR (A3)
  case 0:
  {
    _Unit_Pool_S = ["O_ti_ar_F","O_ti_eng_F","O_ti_exp_F","O_ti_soldier_F","O_ti_light_F","O_ti_lat_F","O_ti_gl_F","O_ti_m_F","O_ti_medic_F","O_ti_SL_F"];
    _Unit_Pool_V = ["O_ti_technical_a_F"];
    _Unit_Pool_T = ["rhs_btr60_vdv","O_ti_technical_a_F"];
	_Unit_Pool_A = ["RHS_Mi24P_vdv","RHS_Mi24V_vdv","RHS_Mi8AMT_vdv","RHS_Mi8mt_vdv","RHS_Mi8MTV3_vdv"];
  };
//-------------------------------------------------------------------------------------------------
// BLUFOR (A3)
  case 1:
