...
_missionList1 = ["missionListAction1","Mission list n°1","",{},{(vehicle player == s3) && (isNil "mission1Completed")}] call ace_interact_menu_fnc_createAction;
[_object, 0, ["ACE_MainActions"],_missionList1] call ace_interact_menu_fnc_addActionToObject;

_missionList2 = ["missionListAction2","Mission list n°2","",{},{(vehicle player == s3) && (isNil "mission1Completed")}] call ace_interact_menu_fnc_createAction;
[_object, 0, ["ACE_MainActions"],_missionList2] call ace_interact_menu_fnc_addActionToObject;

_missionList3 = ["missionListAction3","Mission list n°3","",{},{(vehicle player == s3) && (isNil "mission1Completed")}] call ace_interact_menu_fnc_createAction;
[_object, 0, ["ACE_MainActions"],_missionList3] call ace_interact_menu_fnc_addActionToObject;

_missionList4 = ["missionListAction4","Mission list n°4","",{},{(vehicle player == s3) && (isNil "mission1Completed")}] call ace_interact_menu_fnc_createAction;
[_object, 0, ["ACE_MainActions"],_missionList4] call ace_interact_menu_fnc_addActionToObject;
 ...
 [_object, 0, ["ACE_MainActions","missionListAction1"],_mission1] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction1"],_mission2] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction1"],_mission3] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction1"],_mission4] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction1"],_mission5] call ace_interact_menu_fnc_addActionToObject;
*/
...
[_object, 0, ["ACE_MainActions","missionListAction2"],_mission6] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction2"],_mission7] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction2"],_mission8] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction2"],_mission9] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction2"],_mission10] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction3"],_mission11] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction3"],_mission12] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction3"],_mission13] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction3"],_mission14] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction3"],_mission15] call ace_interact_menu_fnc_addActionToObject;
...
[_object, 0, ["ACE_MainActions","missionListAction4"],_mission16] call ace_interact_menu_fnc_addActionToObject;
