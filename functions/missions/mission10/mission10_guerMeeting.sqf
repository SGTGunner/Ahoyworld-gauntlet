...
if (isNil "s3") then {
    _misHintText = format ["<t align='center' size='2.2'>New Op</t><br/>____________________<br/>A local Guerrilla Leader has requested a meeting with the platoon commander, we currently don't have any mission aborted.<br/><br/>"];
    ["Globalhint_EH", [_misHintText]] call ace_common_fnc_globalEvent;
    gauntlet_missionCounter = gauntlet_missionCounter + 1;
    [{call AW_fnc_missionSelection},[], 30] call ace_common_fnc_waitAndExecute;
