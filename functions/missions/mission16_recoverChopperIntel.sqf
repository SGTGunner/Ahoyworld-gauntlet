...
timerPFHhandle = [_timerPFH,10,[_missionCounter,_missionName,_selectedLocation,_rndPos]] call CBA_fnc_addPerFrameHandler;
...
reinforcementsPFHhandle = [_timerPFH,10,[_missionCounter,_missionName,_selectedLocation,_rndPos]] call CBA_fnc_addPerFrameHandler;
